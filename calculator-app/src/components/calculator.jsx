  ...
  return (
    <div>
      ...
      <div>
        ...
        {/* actual buttons  */}
          <button className='border p-6 text-2xl  font-semibold cursor-default bg-[#e0e0e0] border-x-[#858693] border-t-[#858693]'>AC</button>

          <button className='border p-4 text-2xl  font-semibold cursor-default bg-[#e0e0e0] border-r-[#858693] border-t-[#858693]' onClick={() => handleSignChange("")}>+/-</button>
          ...
          <button className='border p-4 text-2xl  font-semibold cursor-default
           col-span-2 bg-[#e0e0e0] border-[#858693]' onClick={()=>handleNumber('0')}>0</button>

          <button className='border p-4 text-2xl  font-semibold cursor-default
          bg-[#e0e0e0] border-y-[#858693]' onClick={()=>handleNumber('.')}>.</button>
